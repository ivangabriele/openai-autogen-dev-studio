...
async def start():
    ...
    #     ),
    # )
    a = await software_engineer.as_assistant_agent.a_receive(
        message=utils.clean_text(
            "Can you find the SimCity 2000 game main features for me please?"
        ),
        request_reply=True,
        sender=ceo_user_proxy_agent,
        silent=True,
    )
    ...
    print(a)
    print("last_message")
    print(software_engineer.as_assistant_agent.last_message(ceo_user_proxy_agent))
